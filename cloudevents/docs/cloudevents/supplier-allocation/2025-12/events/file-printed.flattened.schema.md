...
<table>
<tbody>
<tr><th>$id</th><td>/supplier-allocation/2025-12/events/file-printed.flattened.schema.json</td></tr>
...
```
{
    "$id": "/supplier-allocation/2025-12/events/file-printed.flattened.schema.json",
