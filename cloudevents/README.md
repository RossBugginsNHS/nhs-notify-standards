...
| **Example Event Instance** | _Generated_                                                                                                                                  | [`output/examples/example-events/nhs-notify-example-event-event.json`](output/examples/example-events/nhs-notify-example-event-event.json)                         | -                                                                                                                                                        |
...
| **Example Event Instance** | _Generated_                                                                                                                                          | [`output/supplier-allocation/example-events/file-received-event.json`](output/supplier-allocation/example-events/file-received-event.json)                         | -                                                                                                                                                        |
